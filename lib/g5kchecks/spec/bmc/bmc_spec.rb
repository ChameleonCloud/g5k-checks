describe "BMC" do
  ...
  before(:all) do
    ...
    it "should have the correct IPv4" do
      ...
      expect(ip_ohai).to eql(ip_api), "#{ip_ohai}, #{ip_api}, network_interfaces, bmc, ip"
    end
    ...
    it "should have the correct Mac Address" do
      ...
      expect(mac_ohai).to eql(mac_api), "#{mac_ohai}, #{mac_api}, network_interfaces, bmc, mac"
    end
    ...
    it "should be a management card" do
      ...
      expect(mgt_ohai).to eql(mgt_api), "#{mgt_ohai}, #{mgt_api}, network_interfaces, bmc, management"
    end
end
